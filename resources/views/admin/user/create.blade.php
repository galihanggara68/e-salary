...
<section class="content-header">
    <h1>
      User {{ $role_id == 1 ? "Admin" : "Karyawan" }} <small>Tambah Data</small>
    </h1>
    <ol class="breadcrumb">
            ...
            <form class="form-horizontal" action="{{ route('admin.user.store')}}" method="POST">
                ...
                <div class="box-body">
                    <div class="form-group @error('confirm_password') has-error @enderror">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" name="confirm_password" placeholder="Masukan Konfirmasi Password" />
